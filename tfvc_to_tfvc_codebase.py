...
target_server_path = "$/SoftwareDev-POC"
local_source_path = r"P:\Work\Migration\SourceTestPath"
local_target_path = r"P:\Work\Migration\TargetTestPath"
...
def analyze_changeset(changeset_details, changeset_id): # DEPRECATED.
    """
...
def process_regular_changeset(changeset_id):
    ...
    if operations:
        ...
        success = process_changeset_operations(operations, changeset_id)
        if not success:
...
def process_changeset_operations(operations, changeset_id):
    """
    ...
    try:
        ...
        add_count = 0 # Files that were successfully added to TFS.
        edit_count = 0 # Files that were successfully edited.
        other_count = 0 # Other operations (delete, etc).
        skipped_count = 0 # Directories that were skipped.
